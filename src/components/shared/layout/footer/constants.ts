...
export const products = [
  ...
  },
  {
    name: 'GUILD TOOLS',
    description:
      'A purpose built control center for guilds and those running scholarship programs.',
    image: '/images/products/acid_02.jpeg',
  },
  {
    name: 'METAVERSE MARKETPLACE',
    description:
      'Bringing the Steam marketplace into the metaverse. Allowing players to cross trade gaming items (NFTs).',
    image: '/images/products/acid_03.jpeg',
  },
];
